<template>
  ...
  >
    ...
    <span class="text-center card-subtitle">Выбранный анализатор будет сравниваться с ruff, black и flake8. Можно также выбрать
      один из них</span>
...
<script setup lang="ts">
    ...
    async function downloadMetrics(taskId: string) {
        ...
        try {
            ...
            downloadError.value =
                error instanceof Error ? error.message : "Ошибка при загрузке метрик";
        } finally {
