<template>
    <v-card class="mx-auto" max-width="700" elevation="5">
        <v-card-title class="text-h5 text-center"> Метрики анализаторов Python-кода </v-card-title>

        <v-card-subtitle class="text-center">
            Измерение производительности статических анализаторов Python
        </v-card-subtitle>
        ...
        <v-card-text>
            <v-form ref="form" @submit.prevent="submitForm">
                ...
                <v-text-field
                    ...
                    hint="Команда для запуска анализатора. Оставьте пустым для использования значения по умолчанию."
                    persistent-hint
